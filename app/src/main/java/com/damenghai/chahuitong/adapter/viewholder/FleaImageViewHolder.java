 ...
 */
public class FleaImageViewHolder extends BaseViewHolder<Flea> {
    ...
    public FleaImageViewHolder(ViewGroup parent) {
    ...
    public FleaImageViewHolder(ViewGroup parent, @LayoutRes int res) {
        super(parent, res);
    }
