 ...
 */
public class GoodsRecycleListAdapter extends BaseRecycleListAdapter<Goods, GoodsRecycleListAdapter.GoodsViewHolder> {

    private boolean mEditable;

    private Map<Integer, Boolean> mStateList;

    public GoodsRecycleListAdapter(Context context, List<Goods> data) {
        super(context, data);
        initState();
    }
    ...
    @Override
    public GoodsRecycleListAdapter.GoodsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.item_list_order_goods, parent, false);
        return new GoodsRecycleListAdapter.GoodsViewHolder(view);
    }
